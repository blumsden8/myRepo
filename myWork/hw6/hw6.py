...
def count_list(lst):
    ...
    return finList
print("count list")
print(count_list([1,1,5,6,6,7,3]))
...
def remove_range(alist, min, max):
    ...
    *** Important: your code must use comprehensions and should not be more than
    ...
    """
    numsWithin = [num for num in alist if (num < min or num > max)]
    return numsWithin
print(remove_range([7, 9, 4, 2, 7, 7, 5, 3, 5, 1, 7, 8, 6, 7], 5, 7))
...
print(word_count_in_set(["sup", "sup", "tart", "fart", "heart", "tart", "12"]))
...
dict = {"Marty": "Cynthia", "Danielle": "Marty"}
print(friend_list(dict))
